            ...
            {currentQuestion.options.map((option, index) => {
              ...
              return (
                <div
                  ...
                  className={`group relative flex items-center p-4 md:p-5 border rounded-2xl cursor-pointer transition-all duration-300 ${isSelected
                ...
                >
                  ...
                  {/* Custom Radio Button */}
                  <div
                    className={`shrink-0 w-6 h-6 rounded-full border-2 transition-all duration-300 flex items-center justify-center ${isSelected
                  ...
                  {/* Option Text */}
                  <span
                    className={`ml-4 text-sm md:text-base font-medium transition-colors duration-300 ${isSelected ? "text-emerald-50" : "text-zinc-300 group-hover:text-white"
                      }`}
                  >
                    {option}
                  </span>
          ...
          {quiz.questions.map((_, index) => {
            ...
            return (
              <button
                ...
                disabled={submitting}
                className={`w-10 h-10 rounded-xl font-bold text-xs transition-all duration-300 ${isCurrent
